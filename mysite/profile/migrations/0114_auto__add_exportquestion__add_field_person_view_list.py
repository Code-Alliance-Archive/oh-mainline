...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExportQuestion'
        db.create_table('profile_exportquestion', (
        ...
        db.send_create_signal('profile', ['ExportQuestion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ExportQuestion'
        db.delete_table('profile_exportquestion')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 5, 8, 49, 43, 829871)', 'auto_now_add': 'True', 'blank': 'True'}),
