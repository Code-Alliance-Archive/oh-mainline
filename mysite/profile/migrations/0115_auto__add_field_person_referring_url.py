...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.referring_url'
        db.add_column('profile_person', 'referring_url', self.gf('django.db.models.fields.URLField')(default='', max_length=2048, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.referring_url'
        db.delete_column('profile_person', 'referring_url')
    ...
    models = {
        ...
        'profile.exportquestion': {
            'Meta': {'object_name': 'ExportQuestion'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profile.Person']"}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profile.FormQuestion']"})
        },
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 9, 5, 45, 32, 343173)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'referring_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '2048', 'blank': 'True'}),
